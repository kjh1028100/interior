...
var installerContainer = document.querySelector(".drawingless");
...
function redirectHome() {
  var home = document.querySelector(".base_home button");
  home.click();
}
...
function _handleSubmit() {
  _handleSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var title, imgObj, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            title = document.querySelector(".save__container input").value;
            imgObj = {
              title: title,
              imageUrl: imageUrl,
              arFloor: _installer.arFloor,
              arSquare: _installer.arSquare,
              arStraight: _installer.arStraight,
              arCircle: _installer.arCircle,
              arImg: _installer.arImg,
              updatePaint: {
                square: _paint.square,
                img: _paint.img,
                circle: _paint.circle,
                straight: _paint.straight,
                floor: _paint.floor
              } || null
            };
            _context.next = 4;
            return fetch("/api/installer/".concat(id, "/save"), {
              method: "POST",
              headers: {
